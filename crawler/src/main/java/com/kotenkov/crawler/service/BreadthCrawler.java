...
public class BreadthCrawler implements Crawler {
    ...
    private static final Logger logger = LogManager.getLogger(BreadthCrawler.class);
    ...
    public Map<String, List<Integer>> crawl(String url, int maxDepth, int maxVisitedPages, String[] searchWords) {
        ...
        //this queue is used to organize breadth-first search. New urls, found in process, will be added to this queue
